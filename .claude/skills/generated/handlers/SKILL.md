...
38 symbols | 13 files | Cohesion: 68%

## When to Use

- Working with code in `electron/`
- Understanding how registerWindowHandlers, registerWallpaperHandlers, registerAllHandlers work
...
| File | Symbols |
|------|---------|
| `electron/main/ipc/handlers/download.handler.ts` | getStateFilePath, writeStateFile, shouldPersistState, cleanupDownload, classifyDownloadError (+8) |
| `electron/main/ipc/handlers/download-queue.ts` | clear, has, enqueue, processQueue, _emitProgress (+2) |
...
1. `gitnexus_context({name: "registerWindowHandlers"})` — see callers and callees
